...
export class AuthenticationService {
  ...
  public async signInApp(){
    const credentials: UserCredential = await signInWithPopup(this.auth, new GoogleAuthProvider())
    window.open("mahavadnya://"+credentials.user.getIdToken());
  }
